    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="form-horizontal" method="POST" action="voters_add.php" enctype="multipart/form-data">
          ...
          <!-- <div class="form-group">
            <label for="name_member_firm" class="col-sm-3 control-label">Name Member Firm</label>
            <div class="col-sm-9">
              <input type="text" class="form-control" id="name_member_firm" name="name_member_firm" required>
            </div>
          </div> -->
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <select class="form-control" id="membership" name="membership"  required>
                ...
                <option value="" disabled selected hidden>Choose Membership</option>
              </select>
            </div>
          </div>

          <!-- <div class="form-group">
            <label for="management_team" class="col-sm-3 control-label">Management Team</label>
            <div class="col-sm-9">
              <input type="text" class="form-control" id="management_team" name="management_team" required>
            </div>
          </div> -->
