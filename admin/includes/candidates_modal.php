        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="candidates_add.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="edit_firstname" class="col-sm-3 control-label">Designation</label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <select class="form-control" id="position" name="position" required>
                        ...
                        <?php
                          $sql = "SELECT * FROM nomination_category_tbl";
                          $query = $conn->query($sql);
                          while($row = $query->fetch_assoc()){
                              if($row['zone'] == 'all'){
                                  $pos = $row['position_type'];
                                  $val = $row['position_type'].'-'.$row['zone'];
                              }else{
                                  $pos = $row['position_type'].' - '.strtoupper($row['zone']);
                                  $val = $row['position_type'].'-'.$row['zone'];
                              }
                            echo "
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="candidates_edit.php">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_desig" name="desig" value="" required>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <select class="form-control" id="posselect" name="position" required>
<!--                        <option value="" selected id="posselect"></option>-->
                ...
                <div class="form-group">
                    <label for="edit_platform" class="col-sm-3 control-label">About</label>
